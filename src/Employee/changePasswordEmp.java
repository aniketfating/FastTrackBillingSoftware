 ...
 */
public class changePasswordEmp extends javax.swing.JFrame {

    /**
     * Creates new form changePassword
     */
    Register reg;
    public changePasswordEmp(Register reg) {
        initComponents();
        this.reg=reg;
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        boolean status=DB_Operation.checkOldPassword(old_pwd,reg.getEmail());
        if(status)
        {
            if(new_pwd.equals(cnew_pwd))
            {
                boolean status2=DB_Operation.updatePassword(new_pwd,reg.getEmail());
                if(status2)
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(changePasswordEmp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new changePasswordEmp(null).setVisible(true);
            }
        });
    }
