...
public class Payment extends javax.swing.JFrame {
    ...
    public Payment(Register reg, HashMap hm, String totalbill, String name, String phno) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean status=DB_Operation .customerBillingDetails(phno, items, date1, time1, reg.getEmail());
        if(status)
        {
